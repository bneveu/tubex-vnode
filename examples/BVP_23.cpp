...
void bvp23(int n, var_type*yp, const var_type*y, var_type t, void*param)
{
    interval ksi=10;
...
AD *ad=new FADBAD_AD(2,bvp23,bvp23);
...
{    
    ...
    solver.set_propa_fxpt_ratio(0.95);
    //solver.set_propa_fxpt_ratio(0.);

    solver.set_var3b_fxpt_ratio(0.95);
