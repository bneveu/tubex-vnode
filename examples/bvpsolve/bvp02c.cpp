...
void bvp02c(int n, var_type*yp, const var_type*y, var_type t, void*param)
{
   interval ksi=0.01;
   yp[0] = y[1];
   yp[1] = y[1]/ksi;
...
AD *ad=new FADBAD_AD(2,bvp02c,bvp02c);
...
{    
  ...
  TFunction f("x1", "x2" ,"(x2;x2/0.01)");
  Interval domain(0.,1);
    //TubeVector x(domain,IntervalVector(2,Interval(-200,200)));
    
    TubeVector x(domain, 2);

    IntervalVector v(2);
    v[0]=Interval(1.,1.);
    v[1]=Interval(-200.,200.);
