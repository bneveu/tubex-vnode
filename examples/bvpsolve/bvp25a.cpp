...
void bvp25a(int n, var_type*yp, const var_type*y, var_type t, void*param)
{
  interval ksi = 10;
  interval k=1;
...
AD *ad=new FADBAD_AD(2,bvp25a,bvp25a);
...
int main() {
  ...
  //    TFunction f("x1", "x2" ,"(x2;10*(x1-x1*x2))");  // occurrences multiples de x1 (moins efficace)
